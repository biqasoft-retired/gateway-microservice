...
public class WidgetDashboardController {
    ...
    public  List<WidgetsDashboard> updateAllDashBoards(@RequestBody List<WidgetsDashboard> dashboardWidgetses, HttpServletResponse response) {
    ...
    public  WidgetsDashboard addNewDashboard(HttpServletResponse response) {
    ...
    public void deleteDashboardById(HttpServletResponse response, @PathVariable("id") String id) {
    ...
    public  WidgetsDashboard updateOneDashboard(@RequestBody WidgetsDashboard dashboardWidgetses, HttpServletResponse response) {
