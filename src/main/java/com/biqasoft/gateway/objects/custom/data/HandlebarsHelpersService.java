...
public class HandlebarsHelpersService {
    ...
    protected void processHandlebarsHelpers(Handlebars handlebars) {
        ...
        handlebars.registerHelper("inc", (context, options) -> {
        ...
        handlebars.registerHelper("serialize", (context, options) -> objectMapper.writeValueAsString(context));
        ...
        handlebars.registerHelper("processCustomFieldValue", (context, options) -> {
